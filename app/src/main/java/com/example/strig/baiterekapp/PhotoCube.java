...
public class PhotoCube {
    ...
    private int[] imageFileIDs = {  // Image file IDs
            R.drawable.baiterek1,
            R.drawable.baiterek2,
            R.drawable.baiterek3,
            R.drawable.baiterek4,
            R.drawable.baiterek5,
            R.drawable.baiterek6
    };
    private int[] textureIDs = new int[numFaces];
    private Bitmap[] bitmap = new Bitmap[numFaces];
    private float cubeHalfSize = 1.2f;
    public static final String TAG = "PHOTO_CUBE_TAG";
